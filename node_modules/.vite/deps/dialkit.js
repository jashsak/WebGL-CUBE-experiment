...
var DialStoreClass = class {
  ...
  registerPanel(id3, name, config) {
    const controls = this.parseConfig(config, "");
    const values = this.flattenValues(config, "");
    this.initTransitionModes(config, "", values);
    this.panels.set(id3, { id: id3, name, controls, values });
    this.snapshots.set(id3, { ...values });
    this.baseValues.set(id3, { ...values });
    this.notifyGlobal();
  }
  updatePanel(id3, name, config) {
    const existing = this.panels.get(id3);
    if (!existing) {
      this.registerPanel(id3, name, config);
      return;
    }
    const controls = this.parseConfig(config, "");
    ...
    const nextPanel = { id: id3, name, controls, values: nextValues };
  ...
  initTransitionModes(config, prefix, values) {
    for (const [key, value] of Object.entries(config)) {
      ...
      } else if (typeof value === "object" && value !== null && !Array.isArray(value) && !this.isActionConfig(value) && !this.isSelectConfig(value) && !this.isSegmentedConfig(value) && !this.isColorConfig(value) && !this.isTextConfig(value)) {
  ...
  parseConfig(config, prefix) {
    ...
    for (const [key, value] of Object.entries(config)) {
      ...
      } else if (this.isSegmentedConfig(value)) {
        controls.push({ type: "segmented", path, label, options: value.options });
  ...
  flattenValues(config, prefix) {
    ...
    for (const [key, value] of Object.entries(config)) {
      ...
      if (Array.isArray(value) && value.length <= 4 && typeof value[0] === "number") {
        ...
        values[path] = value;
      } else if (this.isSelectConfig(value) || this.isSegmentedConfig(value)) {
  ...
  isSegmentedConfig(value) {
    return typeof value === "object" && value !== null && "type" in value && value.type === "segmented" && "options" in value && Array.isArray(value.options);
  }
  isColorConfig(value) {
...
function useDialKit(name, config, options) {
  ...
  const onActionRef = (0, import_react51.useRef)(options?.onAction);
  ...
  const values = (0, import_react51.useSyncExternalStore)(
...
function buildResolvedValues(config, flatValues, prefix) {
  ...
  for (const [key, configValue] of Object.entries(config)) {
    ...
    if (Array.isArray(configValue) && configValue.length <= 4 && typeof configValue[0] === "number") {
      ...
      result[key] = flatValues[path] ?? configValue;
    } else if (isSelectConfig(configValue) || isSegmentedConfig(configValue)) {
...
function isSegmentedConfig(value) {
  return hasType(value, "segmented") && "options" in value && Array.isArray(value.options);
}
...
function Folder({ title, children, defaultOpen = true, isRoot = false, onOpenChange, toolbar }) {
  const [isOpen, setIsOpen] = (0, import_react55.useState)(defaultOpen);
  const [isCollapsed, setIsCollapsed] = (0, import_react55.useState)(!defaultOpen);
  const contentRef = (0, import_react55.useRef)(null);
  const [contentHeight, setContentHeight] = (0, import_react55.useState)(void 0);
  ...
  const folderContent = (0, import_jsx_runtime12.jsxs)("div", { ref: isRoot ? contentRef : void 0, className: `dialkit-folder ${isRoot ? "dialkit-folder-root" : ""}`, children: [
        ...
        isRoot ? (
          ...
          (0, import_jsx_runtime12.jsxs)(
            "svg",
            {
              ...
              fill: "none",
              children: [
                (0, import_jsx_runtime12.jsx)("path", { opacity: "0.5", d: "M6.84766 11.75C6.78583 11.9899 6.75 12.2408 6.75 12.5C6.75 12.7592 6.78583 13.0101 6.84766 13.25H2C1.58579 13.25 1.25 12.9142 1.25 12.5C1.25 12.0858 1.58579 11.75 2 11.75H6.84766ZM14 11.75C14.4142 11.75 14.75 12.0858 14.75 12.5C14.75 12.9142 14.4142 13.25 14 13.25H12.6523C12.7142 13.0101 12.75 12.7592 12.75 12.5C12.75 12.2408 12.7142 11.9899 12.6523 11.75H14ZM3.09766 7.25C3.03583 7.48994 3 7.74075 3 8C3 8.25925 3.03583 8.51006 3.09766 8.75H2C1.58579 8.75 1.25 8.41421 1.25 8C1.25 7.58579 1.58579 7.25 2 7.25H3.09766ZM14 7.25C14.4142 7.25 14.75 7.58579 14.75 8C14.75 8.41421 14.4142 8.75 14 8.75H8.90234C8.96417 8.51006 9 8.25925 9 8C9 7.74075 8.96417 7.48994 8.90234 7.25H14ZM7.59766 2.75C7.53583 2.98994 7.5 3.24075 7.5 3.5C7.5 3.75925 7.53583 4.01006 7.59766 4.25H2C1.58579 4.25 1.25 3.91421 1.25 3.5C1.25 3.08579 1.58579 2.75 2 2.75H7.59766ZM14 2.75C14.4142 2.75 14.75 3.08579 14.75 3.5C14.75 3.91421 14.4142 4.25 14 4.25H13.4023C13.4642 4.01006 13.5 3.75925 13.5 3.5C13.5 3.24075 13.4642 2.98994 13.4023 2.75H14Z", fill: "currentColor" }),
                (0, import_jsx_runtime12.jsx)("circle", { cx: "6", cy: "8", r: "0.998596", fill: "currentColor", stroke: "currentColor", strokeWidth: "1.25" }),
                (0, import_jsx_runtime12.jsx)("circle", { cx: "10.4999", cy: "3.5", r: "0.998657", fill: "currentColor", stroke: "currentColor", strokeWidth: "1.25" }),
                (0, import_jsx_runtime12.jsx)("circle", { cx: "9.75015", cy: "12.5", r: "0.997986", fill: "currentColor", stroke: "currentColor", strokeWidth: "1.25" })
              ]
            }
          )
        ) : (
...
function Slider({
  ...
  const wrapperRef = (0, import_react57.useRef)(null);
  const trackRef = (0, import_react57.useRef)(null);
  const inputRef = (0, import_react57.useRef)(null);
  const labelRef = (0, import_react57.useRef)(null);
  const valueSpanRef = (0, import_react57.useRef)(null);
  const [isInteracting, setIsInteracting] = (0, import_react57.useState)(false);
  const [isDragging2, setIsDragging] = (0, import_react57.useState)(false);
  const [isHovered, setIsHovered] = (0, import_react57.useState)(false);
  const [isValueHovered, setIsValueHovered] = (0, import_react57.useState)(false);
  const [isValueEditable, setIsValueEditable] = (0, import_react57.useState)(false);
  const [showInput, setShowInput] = (0, import_react57.useState)(false);
  const [inputValue, setInputValue] = (0, import_react57.useState)("");
  const hoverTimeoutRef = (0, import_react57.useRef)(null);
  const pointerDownPos = (0, import_react57.useRef)(null);
  const isClickRef = (0, import_react57.useRef)(true);
  const animRef = (0, import_react57.useRef)(null);
  const wrapperRectRef = (0, import_react57.useRef)(null);
  const scaleRef = (0, import_react57.useRef)(1);
  ...
  const positionToValue = (0, import_react57.useCallback)(
    (clientX) => {
  ...
  const percentFromValue = (0, import_react57.useCallback)(
    (v) => (v - min) / (max - min) * 100,
    [min, max]
  );
  const computeRubberStretch = (0, import_react57.useCallback)(
    (clientX, sign) => {
      const rect = wrapperRectRef.current;
      if (!rect) return 0;
  ...
  const handlePointerDown = (0, import_react57.useCallback)(
    (e) => {
      if (showInput) return;
      e.preventDefault();
  ...
  const handlePointerMove = (0, import_react57.useCallback)(
    (e) => {
  ...
  const handlePointerUp = (0, import_react57.useCallback)(
    (e) => {
  ...
  return (0, import_jsx_runtime13.jsx)("div", { ref: wrapperRef, className: "dialkit-slider-wrapper", children: (0, import_jsx_runtime13.jsxs)(
    motion.div,
    {
      ref: trackRef,
      ...
      children: [
        (0, import_jsx_runtime13.jsx)("div", { className: "dialkit-slider-hashmarks", children: hashMarks }),
        ...
        (0, import_jsx_runtime13.jsx)("span", { ref: labelRef, className: "dialkit-slider-label", children: label }),
        showInput ? (0, import_jsx_runtime13.jsx)(
          "input",
          {
            ref: inputRef,
            type: "text",
...
function SegmentedControl({
  ...
  const buttonRefs = (0, import_react59.useRef)(/* @__PURE__ */ new Map());
  const [pillStyle, setPillStyle] = (0, import_react59.useState)(null);
  const hasAnimated = (0, import_react59.useRef)(false);
  ...
  return (0, import_jsx_runtime14.jsxs)("div", { ref: containerRef, className: "dialkit-segmented", children: [
    pillStyle && (0, import_jsx_runtime14.jsx)(
      motion.div,
      {
        className: "dialkit-segmented-pill",
        style: { left: pillStyle.left, top: pillStyle.top, width: pillStyle.width, height: pillStyle.height },
        animate: { left: pillStyle.left, top: pillStyle.top, width: pillStyle.width, height: pillStyle.height },
...
function Toggle({ label, checked, onChange }) {
  return (0, import_jsx_runtime15.jsxs)("div", { className: "dialkit-labeled-control", children: [
    (0, import_jsx_runtime15.jsx)("span", { className: "dialkit-labeled-control-label", children: label }),
...
function SpringVisualization({ spring: spring2, isSimpleMode }) {
  ...
  for (let i = 1; i < 4; i++) {
    ...
    const y = height / 4 * i;
    gridLines.push(
      (0, import_jsx_runtime16.jsx)("line", { x1: x, y1: 0, x2: x, y2: height, stroke: "rgba(255, 255, 255, 0.08)", strokeWidth: "1" }, `v-${i}`),
      (0, import_jsx_runtime16.jsx)("line", { x1: 0, y1: y, x2: width, y2: y, stroke: "rgba(255, 255, 255, 0.08)", strokeWidth: "1" }, `h-${i}`)
    );
  }
  return (0, import_jsx_runtime16.jsxs)("svg", { viewBox: `0 0 ${width} ${height}`, className: "dialkit-spring-viz", children: [
    gridLines,
...
function SpringControl({ panelId, path, label, spring: spring2, onChange }) {
  const mode = (0, import_react61.useSyncExternalStore)(
  ...
  const handleModeChange = (newMode) => {
    ...
    if (newMode === "simple") {
      ...
      onChange({
        ...rest,
        type: "spring",
        visualDuration: spring2.visualDuration ?? 0.3,
        bounce: spring2.bounce ?? 0.2
      });
    } else {
      ...
      onChange({
        ...rest,
        type: "spring",
        stiffness: spring2.stiffness ?? 200,
        damping: spring2.damping ?? 25,
        mass: spring2.mass ?? 1
      });
    }
  };
  ...
  return (0, import_jsx_runtime17.jsx)(Folder, { title: label, defaultOpen: true, children: (0, import_jsx_runtime17.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [
    (0, import_jsx_runtime17.jsx)(SpringVisualization, { spring: spring2, isSimpleMode }),
    (0, import_jsx_runtime17.jsxs)("div", { className: "dialkit-labeled-control", children: [
      (0, import_jsx_runtime17.jsx)("span", { className: "dialkit-labeled-control-label", children: "Type" }),
    ...
    isSimpleMode ? (0, import_jsx_runtime17.jsxs)(import_jsx_runtime17.Fragment, { children: [
      (0, import_jsx_runtime17.jsx)(
        Slider,
        {
          label: "Duration",
  ...
  return (0, import_jsx_runtime18.jsxs)(
    "svg",
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime18.jsx)("path", { d: curvePath, fill: "none", stroke: "rgba(255, 255, 255, 0.6)", strokeWidth: "2", strokeLinecap: "round" })
      ]
    }
  );
}
function TransitionControl({ panelId, path, label, value, onChange }) {
  const mode = (0, import_react62.useSyncExternalStore)(
    (cb) => DialStore.subscribe(panelId, cb),
  ...
  const spring2 = value.type === "spring" ? value : { type: "spring", visualDuration: 0.3, bounce: 0.2 };
  ...
  const handleModeChange = (newMode) => {
    ...
    if (newMode === "easing") {
      ...
      onChange({
        type: "spring",
        visualDuration: spring2.visualDuration ?? (value.type === "easing" ? value.duration : 0.3),
        bounce: spring2.bounce ?? 0.2
      });
    } else {
      onChange({
  ...
  return (0, import_jsx_runtime19.jsx)(Folder, { title: label, defaultOpen: true, children: (0, import_jsx_runtime19.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [
    isEasing ? (0, import_jsx_runtime19.jsx)(EasingVisualization, { easing }) : (0, import_jsx_runtime19.jsx)(SpringVisualization, { spring: spring2, isSimpleMode: isSimpleSpring }),
    (0, import_jsx_runtime19.jsxs)("div", { className: "dialkit-labeled-control", children: [
      (0, import_jsx_runtime19.jsx)("span", { className: "dialkit-labeled-control-label", children: "Type" }),
    ...
    isEasing ? (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
      (0, import_jsx_runtime19.jsx)(Slider, { label: "x1", value: easing.ease[0], onChange: (v) => updateEase(0, v), min: 0, max: 1, step: 0.01 }),
      (0, import_jsx_runtime19.jsx)(Slider, { label: "y1", value: easing.ease[1], onChange: (v) => updateEase(1, v), min: -1, max: 2, step: 0.01 }),
      (0, import_jsx_runtime19.jsx)(Slider, { label: "x2", value: easing.ease[2], onChange: (v) => updateEase(2, v), min: 0, max: 1, step: 0.01 }),
      (0, import_jsx_runtime19.jsx)(Slider, { label: "y2", value: easing.ease[3], onChange: (v) => updateEase(3, v), min: -1, max: 2, step: 0.01 }),
      (0, import_jsx_runtime19.jsx)(Slider, { label: "Duration", value: easing.duration, onChange: (v) => onChange({ ...easing, duration: v }), min: 0.1, max: 2, step: 0.05, unit: "s" }),
      (0, import_jsx_runtime19.jsx)(EaseTextInput, { ease: easing.ease, onChange: (newEase) => onChange({ ...easing, ease: newEase }) })
    ] }) : isSimpleSpring ? (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
      (0, import_jsx_runtime19.jsx)(Slider, { label: "Duration", value: spring2.visualDuration ?? 0.3, onChange: (v) => handleSpringUpdate("visualDuration", v), min: 0.1, max: 1, step: 0.05, unit: "s" }),
      (0, import_jsx_runtime19.jsx)(Slider, { label: "Bounce", value: spring2.bounce ?? 0.2, onChange: (v) => handleSpringUpdate("bounce", v), min: 0, max: 1, step: 0.05 })
    ] }) : (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
      (0, import_jsx_runtime19.jsx)(Slider, { label: "Stiffness", value: spring2.stiffness ?? 400, onChange: (v) => handleSpringUpdate("stiffness", v), min: 1, max: 1e3, step: 10 }),
      (0, import_jsx_runtime19.jsx)(Slider, { label: "Damping", value: spring2.damping ?? 17, onChange: (v) => handleSpringUpdate("damping", v), min: 1, max: 100, step: 1 }),
      (0, import_jsx_runtime19.jsx)(Slider, { label: "Mass", value: spring2.mass ?? 1, onChange: (v) => handleSpringUpdate("mass", v), min: 0.1, max: 10, step: 0.1 })
    ] })
  ] }) });
}
...
function EaseTextInput({ ease: ease2, onChange }) {
  ...
  return (0, import_jsx_runtime19.jsxs)("div", { className: "dialkit-labeled-control", children: [
    (0, import_jsx_runtime19.jsx)("span", { className: "dialkit-labeled-control-label", children: "Ease" }),
    (0, import_jsx_runtime19.jsx)(
      "input",
      {
        type: "text",
...
function TextControl({ label, value, onChange, placeholder }) {
  return (0, import_jsx_runtime20.jsxs)("div", { className: "dialkit-text-control", children: [
    (0, import_jsx_runtime20.jsx)("label", { className: "dialkit-text-label", children: label }),
...
function SelectControl({ label, value, options, onChange }) {
  ...
  return (0, import_jsx_runtime21.jsxs)("div", { className: "dialkit-select-row", children: [
    (0, import_jsx_runtime21.jsxs)(
      "button",
      {
        ...
        children: [
          (0, import_jsx_runtime21.jsx)("span", { className: "dialkit-select-label", children: label }),
          (0, import_jsx_runtime21.jsxs)("div", { className: "dialkit-select-right", children: [
            (0, import_jsx_runtime21.jsx)("span", { className: "dialkit-select-value", children: selectedOption?.label ?? value }),
            (0, import_jsx_runtime21.jsx)(
              motion.svg,
              {
                ...
                children: (0, import_jsx_runtime21.jsx)("path", { d: "M6 9.5L12 15.5L18 9.5" })
              }
            )
          ] })
        ]
    ...
    portalTarget && (0, import_react_dom2.createPortal)(
      (0, import_jsx_runtime21.jsx)(AnimatePresence, { children: isOpen && pos && (0, import_jsx_runtime21.jsx)(
        motion.div,
        {
          ref: dropdownRef,
          ...
          children: normalized.map((option) => (0, import_jsx_runtime21.jsx)(
            "button",
            {
...
function ColorControl({ label, value, onChange }) {
  ...
  return (0, import_jsx_runtime22.jsxs)("div", { className: "dialkit-color-control", children: [
    (0, import_jsx_runtime22.jsx)("span", { className: "dialkit-color-label", children: label }),
    (0, import_jsx_runtime22.jsxs)("div", { className: "dialkit-color-inputs", children: [
      isEditing ? (0, import_jsx_runtime22.jsx)(
        "input",
        {
          type: "text",
...
function PresetManager({ panelId, presets, activePresetId, onAdd }) {
  ...
  return (0, import_jsx_runtime23.jsxs)("div", { className: "dialkit-preset-manager", children: [
    (0, import_jsx_runtime23.jsxs)(
      "button",
      {
        ...
        children: [
          (0, import_jsx_runtime23.jsx)("span", { className: "dialkit-preset-label", children: activePreset ? activePreset.name : "Version 1" }),
          (0, import_jsx_runtime23.jsx)(
            motion.svg,
            {
              ...
              transition: { type: "spring", visualDuration: 0.2, bounce: 0.15 },
              children: (0, import_jsx_runtime23.jsx)("path", { d: "M6 9.5L12 15.5L18 9.5" })
            }
          )
        ]
      }
    ...
    (0, import_react_dom3.createPortal)(
      (0, import_jsx_runtime23.jsx)(AnimatePresence, { children: isOpen && (0, import_jsx_runtime23.jsxs)(
        motion.div,
        {
          ref: dropdownRef,
          ...
          children: [
            (0, import_jsx_runtime23.jsx)(
              "div",
              {
                ...
                children: (0, import_jsx_runtime23.jsx)("span", { className: "dialkit-preset-name", children: "Version 1" })
              }
            ),
            presets.map((preset) => (0, import_jsx_runtime23.jsxs)(
              "div",
              {
                className: "dialkit-preset-item",
                ...
                children: [
                  (0, import_jsx_runtime23.jsx)("span", { className: "dialkit-preset-name", children: preset.name }),
                  (0, import_jsx_runtime23.jsx)(
                    "button",
                    {
                      ...
                      title: "Delete preset",
                      children: (0, import_jsx_runtime23.jsxs)("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
                        (0, import_jsx_runtime23.jsx)("path", { d: "M5 6.5L5.80734 18.2064C5.91582 19.7794 7.22348 21 8.80023 21H15.1998C16.7765 21 18.0842 19.7794 18.1927 18.2064L19 6.5" }),
                        (0, import_jsx_runtime23.jsx)("path", { d: "M10 11V16" }),
                        (0, import_jsx_runtime23.jsx)("path", { d: "M14 11V16" }),
                        (0, import_jsx_runtime23.jsx)("path", { d: "M3.5 6H20.5" }),
                        (0, import_jsx_runtime23.jsx)("path", { d: "M8.07092 5.74621C8.42348 3.89745 10.0485 2.5 12 2.5C13.9515 2.5 15.5765 3.89745 15.9291 5.74621" })
                      ] })
                    }
                  )
                ]
...
function Panel({ panel, defaultOpen = true }) {
  ...
  const [isPanelOpen, setIsPanelOpen] = (0, import_react53.useState)(defaultOpen);
  const values = (0, import_react53.useSyncExternalStore)(
...
Apply these values as the new defaults in the useDialKit call.`;
  ...
  const renderControl = (control) => {
    ...
    switch (control.type) {
      ...
      case "folder":
        return (0, import_jsx_runtime24.jsx)(Folder, { title: control.label, defaultOpen: control.defaultOpen ?? true, children: control.children?.map(renderControl) }, control.path);
      case "text":
        return (0, import_jsx_runtime24.jsx)(
          TextControl,
          {
  ...
  const toolbar = (0, import_jsx_runtime24.jsxs)(import_jsx_runtime24.Fragment, { children: [
    (0, import_jsx_runtime24.jsx)(
      motion.button,
      {
        ...
        whileTap: { scale: 0.9 },
        transition: { type: "spring", visualDuration: 0.15, bounce: 0.3 },
        children: (0, import_jsx_runtime24.jsxs)("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", children: [
          (0, import_jsx_runtime24.jsx)("path", { d: "M4 6H20" }),
          (0, import_jsx_runtime24.jsx)("path", { d: "M4 12H10" }),
          (0, import_jsx_runtime24.jsx)("path", { d: "M15 15L21 15" }),
          (0, import_jsx_runtime24.jsx)("path", { d: "M18 12V18" }),
          (0, import_jsx_runtime24.jsx)("path", { d: "M4 18H10" })
        ] })
      }
    ),
    (0, import_jsx_runtime24.jsx)(
    ...
    (0, import_jsx_runtime24.jsxs)(
      motion.button,
      {
        ...
        transition: { type: "spring", visualDuration: 0.15, bounce: 0.3 },
        children: [
          (0, import_jsx_runtime24.jsx)("span", { className: "dialkit-toolbar-copy-icon-wrap", children: (0, import_jsx_runtime24.jsx)(AnimatePresence, { initial: false, mode: "popLayout", children: copied ? (0, import_jsx_runtime24.jsx)(
            motion.svg,
            {
              ...
              children: (0, import_jsx_runtime24.jsx)("path", { d: "M5 12.75L10 19L19 5" })
            },
            "check"
          ) : (0, import_jsx_runtime24.jsxs)(
            motion.svg,
            {
              ...
              transition: { type: "spring", visualDuration: 0.3, bounce: 0.2 },
              children: [
                (0, import_jsx_runtime24.jsx)("path", { d: "M8 6C8 4.34315 9.34315 3 11 3H13C14.6569 3 16 4.34315 16 6V7H8V6Z", stroke: "currentColor", strokeWidth: "2", strokeLinejoin: "round" }),
                (0, import_jsx_runtime24.jsx)("path", { d: "M19.2405 16.1852L18.5436 14.3733C18.4571 14.1484 18.241 14 18 14C17.759 14 17.5429 14.1484 17.4564 14.3733L16.7595 16.1852C16.658 16.4493 16.4493 16.658 16.1852 16.7595L14.3733 17.4564C14.1484 17.5429 14 17.759 14 18C14 18.241 14.1484 18.4571 14.3733 18.5436L16.1852 19.2405C16.4493 19.342 16.658 19.5507 16.7595 19.8148L17.4564 21.6267C17.5429 21.8516 17.759 22 18 22C18.241 22 18.4571 21.8516 18.5436 21.6267L19.2405 19.8148C19.342 19.5507 19.5507 19.342 19.8148 19.2405L21.6267 18.5436C21.8516 18.4571 22 18.241 22 18C22 17.759 21.8516 17.5429 21.6267 17.4564L19.8148 16.7595C19.5507 16.658 19.342 16.4493 19.2405 16.1852Z", fill: "currentColor" }),
                (0, import_jsx_runtime24.jsx)("path", { d: "M16 5H17C18.6569 5 20 6.34315 20 8V11M8 5H7C5.34315 5 4 6.34315 4 8V18C4 19.6569 5.34315 21 7 21H12", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })
              ]
            },
            "clipboard"
          ) }) }),
  ...
  return (0, import_jsx_runtime24.jsx)("div", { className: "dialkit-panel-wrapper", children: (0, import_jsx_runtime24.jsx)(Folder, { title: panel.name, defaultOpen, isRoot: true, onOpenChange: setIsPanelOpen, toolbar, children: renderControls() }) });
}
function DialRoot({ position = "top-right", defaultOpen = true }) {
  ...
  const content = (0, import_jsx_runtime25.jsx)("div", { className: "dialkit-root", children: (0, import_jsx_runtime25.jsx)("div", { className: "dialkit-panel", "data-position": position, children: panels.map((panel) => (0, import_jsx_runtime25.jsx)(Panel, { panel, defaultOpen }, panel.id)) }) });
  return (0, import_react_dom.createPortal)(content, document.body);
}
function ButtonGroup({ buttons }) {
  return (0, import_jsx_runtime26.jsx)("div", { className: "dialkit-button-group", children: buttons.map((button, index) => (0, import_jsx_runtime26.jsx)(
    "button",
    {
      className: "dialkit-button",
