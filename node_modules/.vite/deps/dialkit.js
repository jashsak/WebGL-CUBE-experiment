      ...
      "button",
      {
        ...
        children: [
          ...
          (0, import_jsx_runtime10.jsxs)("div", { className: "dialkit-select-right", children: [
            (0, import_jsx_runtime10.jsx)("span", { className: "dialkit-select-value", children: selectedOption?.label ?? value }),
...
Apply these values as the new defaults in the useDialKit call.`;
  ...
  const renderControl = (control) => {
    ...
    switch (control.type) {
      ...
      case "folder":
        return (0, import_jsx_runtime13.jsx)(Folder, { title: control.label, defaultOpen: control.defaultOpen ?? true, children: control.children?.map(renderControl) }, control.path);
      case "text":
        return (0, import_jsx_runtime13.jsx)(
          TextControl,
          {
  ...
  return (0, import_jsx_runtime13.jsx)("div", { className: "dialkit-panel-wrapper", children: (0, import_jsx_runtime13.jsx)(Folder, { title: panel.name, defaultOpen, isRoot: true, onOpenChange: setIsPanelOpen, toolbar, children: renderControls() }) });
}
function DialRoot({ position = "top-right", defaultOpen = true }) {
  ...
  const content = (0, import_jsx_runtime14.jsx)("div", { className: "dialkit-root", children: (0, import_jsx_runtime14.jsx)("div", { className: "dialkit-panel", "data-position": position, children: panels.map((panel) => (0, import_jsx_runtime14.jsx)(Panel, { panel, defaultOpen }, panel.id)) }) });
